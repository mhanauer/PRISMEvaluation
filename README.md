...
data = apply(data,2, function(x){ifelse(x == "[Scribbled out 5 and underlined 8]", 8, ifelse(x == "10 (Crossed out \"7\")", 10, ifelse(x == "2 \"Willing but a lot to learn", 2, ifelse(x == "5 to 7", 6, ifelse(x == "6 (3 crossed out)", 6, ifelse(x == "7 Still need practice!!", 7 , ifelse(x == "9 10 sometimes I mess up.", 9.5, ifelse(x== "As long as I know what they are.", 9, ifelse(x == "9_12", 10.5, ifelse(x == "S", NA, ifelse(x == "Same response as on the PRE-ASSESSMENT.", NA, ifelse(x == "A + Strongly Agree", 5, ifelse(x== "Strongly Agree", 7, ifelse(x == "Strongly Disagree", 1, ifelse(x == "Disagree", 2, ifelse(x == "Neutral", 3, ifelse(x == "Agree", 4, ifelse(x == "Strongly Agree", 5, ifelse(x == "Circled Strongly Agree and Agree", 4, ifelse(x == "Neural", 3, ifelse(x== "Stringly Agree", 5,ifelse(x == "Strongly Agree [Crossed out \"Strongly Disagree\"]", 5, ifelse(x == "Agree *Strongly Agree*", 4, ifelse(x == "D_N", NA, ifelse(x == "N + Agree", 4, ifelse(x == "Neutral ", 3, ifelse(x == "Nuetral", 3,ifelse(x == "Strongly agree", 5, ifelse(x == "Strongly Agree ", 5,x)))))))))))))))))))))))))))))})
