...
Allied media had different outcomes.
```{r}
...
datMean = round(datMean,2); datMean[,12:14]
```
...
n = nrow(datLikert);n
# No just change everything that is greater than or equal to 5 to 1 sum of all them and then divide by n
